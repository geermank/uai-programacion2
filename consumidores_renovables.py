...
def main():
    dataframe_energy = get_dataframe(constantes.ARCHIVO_ENERGIAS_RENOVABLES, constantes.COLUMNA_CODIGOS_PAISES)
    ...
    dataframe_energy_per_year = get_dataframe(constantes.ARCHIVO_ENERGIAS_RENOVABLES, constantes.COLUMNA_CODIGOS_PAISES)
